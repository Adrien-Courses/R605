...
> - [Vlad Mihalcea](https://vladmihalcea.com/) avec son [blog](https://vladmihalcea.com/blog/) et son [livre](https://vladmihalcea.com/books/high-performance-java-persistence/) 
> - [José Paumard](https://blog.paumard.org/) qui propose des playlist vidéos sur [API JDBC](https://www.youtube.com/playlist?list=PLzzeuFUy_Cnheztz2UEfV1UMeeowaevwt) et [API JPA](https://www.youtube.com/playlist?list=PLzzeuFUy_CnhVfJIKyc3okTiiCc0anutx)
...
- [Spring Data JPA]({{< relref "spring_data_jpa/index" >}}) : Une extension de JPA intégrée à l'écosystème Spring, conçue pour encore simplifier la gestion des données. Elle propose une abstraction supplémentaire qui minimise le code nécessaire pour les opérations CRUD et permet de se concentrer sur la logique métier.

Le cours évolue chaque année : la page [Quoi de neuf]({{< relref "changelog/" >}}) liste les ajouts d'un millésime à l'autre, et les supports projetés sont archivés par année dans [Ressources]({{< relref "ressources/" >}}).
